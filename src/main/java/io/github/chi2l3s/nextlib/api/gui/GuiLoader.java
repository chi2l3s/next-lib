...
public class GuiLoader {
    public static Gui load(JavaPlugin plugin, GuiManager manager, ConfigurationSection section) {
        ...
        Gui gui = new Gui(plugin, manager, title, size);
    ...
    private static List<Integer> resolveSlots(JavaPlugin plugin, ConfigurationSection itemSection, String itemKey, int size) {
        Set<Integer> slots = new LinkedHashSet<>();

        List<String> configuredSlots = itemSection.getStringList("slots");
